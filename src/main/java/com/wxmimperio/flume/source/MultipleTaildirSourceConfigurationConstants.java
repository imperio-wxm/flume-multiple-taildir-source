...
public class MultipleTaildirSourceConfigurationConstants {
    /**
    ...
    public static final String FORCE_REFRESH_INTERVAL_MS = "forceRefreshIntervalMs";
    public static final long DEFAULT_FORCE_REFRESH_INTERVAL_MS = 2 * 60 * 1000;

    public static final String FILE_PATH_REGULAR_EXPRESSION = "filePathRegularExpression";
    public static final String DEFAULT_FILE_PATH_REGULAR_EXPRESSION = null;
}
