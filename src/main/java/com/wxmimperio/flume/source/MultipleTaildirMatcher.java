 ...
 *
 * @see MultipleTaildirSource
 * @see MultipleReliableTaildirEventReader
 * @see MultipleTaildirSourceConfigurationConstants
 */
@InterfaceAudience.Private
@InterfaceStability.Evolving
public class MultipleTaildirMatcher {
    private static final Logger logger = LoggerFactory.getLogger(MultipleTaildirMatcher.class);
    ...
    private long getAllFilesCost = -1;
     ...
     * @see MultipleTaildirSourceConfigurationConstants
     */
    MultipleTaildirMatcher(String fileGroup, String filePattern, boolean cachePatternMatching,
                           long forceRefreshIntervalMs, String filePathRegularExpression) {
        ...
        if (!StringUtils.isEmpty(this.filePathRegularExpression)) {
            pattern = Pattern.compile(this.filePathRegularExpression);
        }
    ...
    public boolean equals(Object o) {
        ...
        MultipleTaildirMatcher that = (MultipleTaildirMatcher) o;
    ...
    public long getGetAllFilesCost() {
        return getAllFilesCost;
    }
}