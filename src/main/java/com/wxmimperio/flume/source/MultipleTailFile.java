...
import static com.wxmimperio.flume.source.MultipleTaildirSourceConfigurationConstants.BYTE_OFFSET_HEADER_KEY;


public class MultipleTailFile {
    private static final Logger logger = LoggerFactory.getLogger(MultipleTailFile.class);
    ...
    public MultipleTailFile(File file, Map<String, String> headers, long inode, long pos)
            throws IOException {
